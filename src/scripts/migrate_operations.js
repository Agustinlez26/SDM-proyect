...
try {
    ...
    await connection.query(`
        ...
        INSERT INTO product_categories (name, is_active) VALUES ('Materias primas', TRUE)
        ...
        VALUES
            ('CAL-CLA', 'Calabaza clasica', 'Calabaza comun para SP, criollos y coquitos', (SELECT id FROM product_categories WHERE name = 'Materias primas'), '', '', TRUE, 'raw_material', FALSE, FALSE, FALSE),
            ('CAL-SEL', 'Calabaza seleccionada', 'Calabaza seleccionada para mates con terminacion artesanal', (SELECT id FROM product_categories WHERE name = 'Materias primas'), '', '', TRUE, 'raw_material', FALSE, FALSE, FALSE),
            ('CAL-GAL', 'Calabaza galleta', 'Calabaza tipo galleta', (SELECT id FROM product_categories WHERE name = 'Materias primas'), '', '', TRUE, 'raw_material', FALSE, FALSE, FALSE),
            ('BAS-CUE-CRU', 'Base de cuero crudo', 'Base utilizada para armar Mate SP', (SELECT id FROM product_categories WHERE name = 'Materias primas'), '', '', TRUE, 'component', FALSE, FALSE, FALSE)
        ...
        WHERE p.item_type IN ('raw_material', 'component');
    `)
